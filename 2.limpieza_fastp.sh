...
# Directorios
RAW_DIR=1.reads_limpios
OUT_DIR=2.reads_limpios
REPORT_DIR=2.reporte_limpieza
...
do
    ...
    fastp \
        -i ${R1} \
        -I ${R2} \
        -o ${OUT_DIR}/${SAMPLE}_clean2_R1.fastq.gz \
        -O ${OUT_DIR}/${SAMPLE}_clean2_R2.fastq.gz \
        --adapter_sequence TCGTATGCCGTCTTCTGCTTGT \
        --adapter_sequence_r2 TCGTATGCCGTCTTCTGCTTGT \
        --trim_poly_x \
	--trim_poly_g \
